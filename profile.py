...
pc.defineParameter(
    name="sdr_nodetype",
    description="Type of compute node to used for SDR node.",
...
node1.addService(rspec.Execute(shell="bash", command=SRS_DEPLOY_SCRIPT))
node2.addService(rspec.Execute(shell="bash", command=SRS_DEPLOY_SCRIPT))
